...
TString extraText2   = ""; // "Simulation"For Simulation Preliminary on two lines
...
TString lumi_13TeV = "x nb^{-1}";
TString lumi_8TeV  = "19.7 fb^{-1}";
TString lumi_7TeV  = "5.1 fb^{-1}";
TString lumi_8TeVlowpT = "5.61 pb^{-1}";
bool drawLogo      = false;
...
TCanvas* tdrCanvas(const char* canvName, TH1F *h,
