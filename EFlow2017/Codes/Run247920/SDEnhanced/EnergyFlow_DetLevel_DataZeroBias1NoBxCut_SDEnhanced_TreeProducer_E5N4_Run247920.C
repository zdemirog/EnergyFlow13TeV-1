...
void  EnergyFlow_DetLevel_DataZeroBias1NoBxCut_SDEnhanced_TreeProducer_E5N4_Run247920()

{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_JINSTBinning_SignalTower_SDEnhanced_NoiseCut4GeV_Emin5GeV_Run247920.root",readfilesname.c_str());
	...
	if (filetype =="DATA" && run==247920) RunCut=true;
	...
	if (filetype =="DATA")LumiCut=(lumi>=1 &&lumi<200 || lumi>=202 && lumi<374 || lumi>=376 && lumi<771);
