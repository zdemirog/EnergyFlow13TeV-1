...
vector<float> *SDHFSignalTower=0;
vector<float> *SDHFVetoTower=0;
...
// List of branches
TBranch        *b_CaloTower;
TBranch        *b_SDHFSignalTower;
TBranch        *b_SDHFVetoTower;
TBranch        *b_HCALTower;
TBranch        *b_RecHit;
...
float EtaBins[31]={-6.6,-5.205,-4.903,-4.552,-4.204,-3.853,-3.503,-3.152,-2.650,-2.172,-1.74,-1.392,-1.044,-0.696,-0.348,
    0,0.348,0.696,1.044,1.392,1.74,2.172,2.650,3.152,3.503,3.853,4.204,4.552,4.903,5.205, 6.6};
...
Double_t SDHFSignalTowerEtaSums[BIN];
Double_t SDHFVetoTowerEtaSums[BIN];
...
int lumimin,lumimax;
float etamin,etamax,emin,minXiSD,etaminMinus,etamaxMinus,CastorNoiseThreshold,NoiseCut;
