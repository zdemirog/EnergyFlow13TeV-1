...
void  EnergyFlow_DetLevel_TuneMonash_AllCollect_TreeProducer()

{
	...
	sprintf(title,"EFlow_DetLevel_%s_AllCollection_JINSTBinning_INEL_Noisecut4GeV_cltwrNewcond_Emin4GeV.root",readfilesname.c_str());
