...
void  EnergyFlow_DetLevel_DataZeroBias1_FatBx208_SDEnhanced_TreeProducer_E5N4_Run247324()

{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_JINSTBinning_SignalTower_SDEnhanced_NoiseCut4GeV_Emin5GeV_Run247324_TrgPass.root",readfilesname.c_str());
