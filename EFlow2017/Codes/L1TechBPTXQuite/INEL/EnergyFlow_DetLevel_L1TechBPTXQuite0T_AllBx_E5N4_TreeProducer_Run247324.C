...
void  EnergyFlow_DetLevel_L1TechBPTXQuite0T_AllBx_E5N4_TreeProducer_Run247324()

{
	...
	sprintf(title,"EFlow_DetLevel_%s_AllCollect_JINSTBinning_AllBx_INEL_L1TechTriggerBit7_Emin5GeV_NoiseCut4GeV_Run247324.root",readfilesname.c_str());
