...
void  EnergyFlow_DetLevel_L1TechQuiteBPTX0T_AllBx_SDEnhanced_TreeProducer_E5N4_Run247324()

{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_JINSTBinning_L1TechBPTXQuiet_SDEnhanced_AllBx_SignalTower_E5N4_Run247324.root",readfilesname.c_str());
