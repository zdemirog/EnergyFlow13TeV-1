...
#include "MinBias_Epos0T_13TeV-pythia8.h"
using namespace std;
...
void  EnergyFlow_GenLevel_Epos0T_TreeProducer()

{
	...
	//------- File Number ---------//                                                                                                                                                
        for (int fn=0; fn < fnumber ; fn++){
            // --- open file in EOS                                                                                                                                                      
            char Fname[999];
            sprintf(Fname,"ReggeGribovPartonMC_%d3TeV-EPOS_MagnetOff_trees.root",(fn+1));
            string sFname(Fname);
