...
void  EnergyFlow_DetLevel_qgsjetII0T_AllCollect_TreeProducer()

{
	...
	sprintf(title,"EFlow_DetLevel_%s_AllCollect_LastRing5p205_NoiseCut0GeV_WithNewEta_Emin5GeV_cltwrNewcond.root",readfilesname.c_str());
