...
void  EnergyFlow_DetLevel_HFOR_ZeroBias1_r251721_TreeProducer_with5GeV()

{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_HFOR_r251721_tree_3p8Tesla_with5GeV.root",readfilesname.c_str());
