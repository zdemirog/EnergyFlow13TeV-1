...
void  EnergyFlow_DetLevel_HFOR_ZeroBias1_r255031_TreeProducer_with4p5GeV()
{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_HFOR_r255031_tree_3p8Tesla_with4p5GeV.root",readfilesname.c_str());
