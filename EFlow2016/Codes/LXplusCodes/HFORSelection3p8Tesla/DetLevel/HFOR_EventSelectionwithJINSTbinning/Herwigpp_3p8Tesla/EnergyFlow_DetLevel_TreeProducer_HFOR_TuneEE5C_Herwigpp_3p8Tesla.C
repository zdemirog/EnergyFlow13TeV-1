...
void  EnergyFlow_DetLevel_TreeProducer_HFOR_TuneEE5C_Herwigpp_3p8Tesla()

{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_HFOR_tree_3p8Tesla_with5GeV.root",readfilesname.c_str());
