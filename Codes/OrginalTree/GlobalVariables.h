...
int nEtaBins =28;
float EtaBins[29]={-5.191,-4.889,-4.538,-4.191,-3.839,-3.489,-3.139,-2.650,-2.172,-1.74,-1.392,-1.044,-0.696,-0.348,
		   0,0.348,0.696,1.044,1.392,1.74,2.172,2.650,3.139,3.489,3.839,4.191,4.538,4.889,5.191};
...
bool VtxCut(false);
int lumimin,lumimax;
float etamin,etamax,emin,minXiSD,etaminMinus,etamaxMinus;
