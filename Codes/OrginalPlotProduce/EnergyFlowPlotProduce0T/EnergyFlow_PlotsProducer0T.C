...
void  EnergyFlow_PlotsProducer0T()

{
  ...
  bool save =true;
  bool ratioMC=false;
  string filenames[6] ={"../EFlowTreeRootFile/8EFlow_DetLevel_DataZeroBiasAllBx_r247324_0Tesla_lumi97.root",
			"../EFlowTreeRootFile/3EFlow_DetLevel_DataExpressPhysiscAllBx_r247324_Express0Tesla_lumi97.root",
            "../EFlowTreeRootFile/1EFlow_DetLevel_merge_tree_ZeroBias1_LHCf_0Tr247934.root",
			"../EFlowTreeRootFile/EFlow_DetLevel_pythia8_Monash_tree_0Tesla.root",
            "../EFlowTreeRootFile/EFlow_DetLevel_herwigpp_tree_0Tesla.root",
            "../EFlowTreeRootFile/EFlow_DetLevel_epos_tree_0Tesla.root"
			 
  };
    
    
  string energyname[4]={"RecHit","CaloTower","PFClusters","Gen"};
  string fname[6]={"ZeroBias0T","ExpPhy0T","LhcfZB0T","P8Monash0T","Herwig0T","Epos0T"};
  ...
  //"ZeroBias3p8","ExpPhy3p8","P8Monash3p8","Cuetp8m1_3p8","Epos3p8"
    //EnergyDistributions
...
*/
  ...
  //string energyname[4]={"RecHit","CaloTower","PFClusters","Gen"};
  //string fname[11]={"ZeroBias3p8","ExpPhy3p8","P8Monash3p8","Cuetp8m1_3p8","Epos3p8"};
  for (int f=0; f<ftyp; f++){
    ...
    if(f>1)DataDetLOverMCDetL[f-2]->Divide(Energy[0][2],Energy[f][2], 1.,1.,"B");
    //if(f>1)MCDetLOverMCGenL[f-2]->Divide(Energy[f][2],Energy[f][3], 1.,1.,"B");
 ...
 // DataDetLOverMCDetL[3]->SetLineColor(kBlue);
  ...
  leg[0]->AddEntry(Energy[0][2],"ZB0T_lumi97","PL");
  leg[0]->AddEntry(Energy[1][2],"ExpPhy0T_lumi97","PL");
  leg[0]->AddEntry(Energy[2][2],"LhcfZB1_0Tr247934","PL");
  //leg[0]->AddEntry(Energy[3][2],"Monash0T","PL");
  //leg[0]->AddEntry(Energy[4][2],"Herwigg0T","PL");
  //leg[0]->AddEntry(Energy[5][2],"Epos0T","PL");
...
/*
  ...
  leg[3]->AddEntry(DataDetLOverMCDetL[1],"pythia8MBR","L");
  leg[3]->AddEntry(DataDetLOverMCDetL[2],"herwigpp","L");
  leg[3]->AddEntry(DataDetLOverMCDetL[3],"epos","L");
  leg[3]->AddEntry(DataDetLOverMCDetL[4],"qgsjetII","L");
 ...
 */
  ...
  tex->DrawLatex(0.75,0.85,"DATA0T");
  leg[0]->Draw();
  sprintf(title,"Plots/EnergyFlow_0T_DataExpAndZB1vsLhcfZB1.pdf");
...
/*
 //------------------ MC --------------------//
  ...
  c[3]->cd();
  for (int f=0; f<5; f++)DataDetLOverMCDetL[f]->Draw("same hist");
