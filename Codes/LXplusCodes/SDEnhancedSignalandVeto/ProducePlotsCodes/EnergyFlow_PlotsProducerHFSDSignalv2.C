...
void  EnergyFlow_PlotsProducerHFSDSignalv2()

{
  ...
  bool ratioMC=false;
  bool energydist=false;
  bool unfold =true;
  bool unfoldratio=false;
  string filenames[15] ={
      "/Volumes/BACKUP2/SDEnhancedAnd/Data/EFlow_DetLevel_MinBias_DataZeroBias1_13TeVAllBx_0T_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",
      
      "/Volumes/BACKUP2/SDEnhancedAnd/MCDetLevel/EFlow_DetLevel_MinBias_TuneMonash_13TeV-pythia8_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/MCDetLevel/EFlow_DetLevel_MinBias_TuneMBR_13TeV-pythia8_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/MCDetLevel/EFlow_DetLevel_MinBias_Herwig_13TeV-pythia8_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/MCDetLevel/EFlow_DetLevel_MinBias_Epos0T_13TeV-pythia8_AllCollect_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/MCDetLevel/EFlow_DetLevel_MinBias_qgsjetII_13TeV-pythia8_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",
      
      "/Volumes/BACKUP2/SDEnhancedAnd/GenLevelMC/EFlow_GenLevel_MinBias_TuneMonash_13TeV-pythia8_0Tesla_SDEnhanced_FromBenoit_Full.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/GenLevelMC/EFlow_GenLevel_MinBias_TuneMBR_13TeV-pythia8_0Tesla_SDEnhanced_FromBenoit_Full.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/GenLevelMC/EFlow_GenLevel_MinBias_Herwig_13TeV-pythia8_0Tesla_SDEnhanced_FromBenoit_Full.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/GenLevelMC/EFlow_GenLevel_MinBias_Epos0T_13TeV-pythia8_0Tesla_SDEnhanced_FromBenoit_Full.root",
      "/Volumes/BACKUP2/SDEnhancedAnd/GenLevelMC/EFlow_GenLevel_MinBias_qgsjetII_13TeV-pythia8_0Tesla_SDEnhanced_FromBenoit_Full.root",
      
      "/Volumes/BACKUP2/SDEnhancedAnd/Data/EFlow_DetLevel_MinBias_DataZeroBias1_13TeVAllBx_0T_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",//5 GeV cut Data
      "/Volumes/BACKUP2/SDEnhancedAnd/Data/EFlow_DetLevel_MinBias_DataZeroBias1_13TeVAllBx_0T_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5p5GeV.root",//5.5 GeV cut Data
      
      "/Volumes/BACKUP2/SDEnhancedAnd/MCDetLevel/EFlow_DetLevel_MinBias_TuneMonash_13TeV-pythia8_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5GeV.root",// 5 GeV cut MC
      "/Volumes/BACKUP2/SDEnhancedAnd/Monash5p5/EFlow_DetLevel_MinBias_TuneMonash_13TeV-pythia8_JINSTBinning_SDEnhanced_NoiseCut4GeV_Emin5p5GeV.root"// 5.5 GeV cut MC
  ...
  for (int f=0; f<ftyp; f++){
   ...
   // file[f]   = new TFile(filenames[f].c_str(),"READ");
	...
	if(f<6 || f>10){
	  ...
	  //----------------------- SDHFSignalTower -------------//
	  for(unsigned long cal=0; cal<SDHFSignalTower->size(); cal++) {
	    //  for(unsigned long cal=1; cal<(CaloTower->size())-1; cal++) {
	    CaloEtaSums[cal]=SDHFSignalTower->at(cal);
	  ...
	  for (int k=0;k<nEtaBins;k++){
        ...
        //cout<<"file : "<<filenames[f].c_str()<<"Event : "<<ev<<"ETA : " <<k<< "HFM : " <<CaloEtaSums[k]<< " HFP : "<<CaloEtaSums[29-k]<<endl;
	...
	if (f>5 && f<11 ){
	  ...
	  for(unsigned long gen=0; gen<SignalGen->size() ; gen++) {
	    ...
	    //if (gen == 30)cout<<Gen->at(gen)<<endl;
	  }
	  ...
	  for (int k=0;k<nEtaBins;k++){
	    ...
	    //Energy_[f][3]->Fill(k,GenEtaSums[k]);// All CMS
	    HFPlusHFMinusGen =etanorm * (GenEtaSums[k] + GenEtaSums[29-k]);
         // cout<<"file : "<<filenames[f].c_str()<<"Event : "<<ev<<"ETA : " <<k<< "HFM : " <<GenEtaSums[k]<< " HFP : "<<GenEtaSums[29-k]<<endl;
          
	    Energy_[f][3]->Fill(k,HFPlusHFMinusGen);// (CastorP + HFPlus + HFMinus)/2.
	    PFClustersEnergy[f][k]->Fill(HFPlusHFMinusGen);
	  } 
	}
      }//event
  }//File
 ...
 ///{"RecHit","CaloTower","PFClusters","Gen","PFCandidate","DetGenGen"}
  ...
  if (DataMCCompare){
    ...
    leg[0]->Draw();
    sprintf(title,"Plots_SDEnhanced_v2/EnergyFlow_0T_Data.pdf");
   ...
   // EnergyFlow_pythia8_TuneMBR_CaloTower3p8T->Draw("same");//Magnet Of
    ...
    leg[8]->Draw();
    tex->DrawLatex(0.75,0.15,"B = 0 T");
    sprintf(title,"Plots_SDEnhanced_v2/EnergyFlow_Data_MC_Magnet_on_off.pdf");
    ...
    */
    ...
    sprintf(title,"Plots_SDEnhanced_v2/EnergyFlow_0T_Pythia8Monash.pdf");
    ...
    sprintf(title,"Plots_SDEnhanced_v2/EnergyFlow_0T_Data_MC_CaloTower.pdf"); if(save)c[2]->SaveAs(title);
    ...
    sprintf(title,"Plots_SDEnhanced_v2/DataDetLOverMCDetL.pdf");
  ...
  if(ratioMC){
    ...
    tex->DrawLatex(0.75,0.15,"B = 0 T");
    sprintf(title,"Plots_SDEnhanced_v2/EnergyFlow_0T_MC_Det_GenLevel_Comp.pdf"); if(save)c[4]->SaveAs(title);
    ...
    sprintf(title,"Plots_SDEnhanced_v2/MCDetLOverMCGenL.pdf");
  ...
  if(unfold){
    ...
    */
     ...
     //Float_t ModelUnc[]={0.665,0.520,0.470,0.446,0.568,0.233,0.160};// my calc
      ...
      Float_t ModelUnc[]={0.294383,0.249709,0.241735,0.260377,0.352615,0.310996,0.220731};
   ...
   //------LEGENDS--------------------//
    ...
    sprintf(title,"Plots_SDEnhanced_v2/Unfolded_Data.pdf"); if(save)c[14]->SaveAs(title);
    ...
    sprintf(title,"Plots_SDEnhanced_v2/DataGenLOverMCGenL1.pdf");
    ...
    sprintf(title,"Plots_SDEnhanced_v2/Unfolded_Data2.pdf"); if(save)c[16]->SaveAs(title);
    ...
    sprintf(title,"Plots_SDEnhanced_v2/DataGenLOverMCGenL.pdf");
