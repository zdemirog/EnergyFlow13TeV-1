...
void  EnergyFlow_DetLevel_Herwig0T_AllCollect_TreeProducer()

{
	...
	sprintf(title,"EFlow_DetLevel_%s_AllCollect_JINSTBinning_WithoutHFAnd_NoiseCut4GeV_Emin5p5GeV.root",readfilesname.c_str());
