...
#include "MinBias_TuneEE5C_13TeV_herwigpp.h"
using namespace std;
...
void  EnergyFlow_DetLevel_TreeProducer_HFAND_TuneEE5C_Herwigpp_3p8Tesla_with4GeV()

{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_HFAND_tree_3p8Tesla_with4GeV.root",readfilesname.c_str());
