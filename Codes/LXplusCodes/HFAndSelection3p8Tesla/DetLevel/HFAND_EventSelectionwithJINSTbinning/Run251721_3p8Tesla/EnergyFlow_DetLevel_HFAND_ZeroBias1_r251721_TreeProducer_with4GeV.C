...
void  EnergyFlow_DetLevel_HFAND_ZeroBias1_r251721_TreeProducer_with4GeV()

{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_HFAND_r251721_tree_3p8Tesla_with4GeV.root",readfilesname.c_str());
