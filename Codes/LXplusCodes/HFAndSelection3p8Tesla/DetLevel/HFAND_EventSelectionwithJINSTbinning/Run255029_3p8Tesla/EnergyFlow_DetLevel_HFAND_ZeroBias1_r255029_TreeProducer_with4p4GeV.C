...
void  EnergyFlow_DetLevel_HFAND_ZeroBias1_r255029_TreeProducer_with4p4GeV()
{
  ...
  for (int f=0; f<ftyp; f++){
    ...
    sprintf(title,"EFlow_DetLevel_%s_HFAND_r255029_tree_3p8Tesla_with4p4GeV.root",readfilesname.c_str());
