...
void  EnergyFlow_DetLevel_HfSelection_WithCastor_TreeProducer( )

{
    ...
    string filenames[6] ={"root://eoscms.cern.ch//eos/cms/store/user/higgs313/CFFtrees/ZeroBias_byHans/data_ZeroBias1_Run2015A_Run247324_trees.root",
	//"root://eoscms.cern.ch//eos/cms/store/user/higgs313/CFFtrees/ZeroBias_byHans/data_ZeroBias1_Run2015A_Run247324_trees.root",
	...
	sprintf(title,"EFlow_DetLevel_%s_tree_0Tesla.root",fname[f].c_str());
